 ...
 * 
 * modified by @lweber 2023-01-30
 * 
 */
public class MoleculeStandardizer_LW {
	...
	public static void standardize( StereoMolecule mol, int mode) throws Exception {
		...
		//LW removed charge neutralization
		//int remainingCharge = mol.canonizeCharge( true, true );
		//if (remainingCharge != 0 ) neutralizeCharges( mol, mode, remainingCharge );
	}
